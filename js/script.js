...
async function loadSettings() {
  try {
    ...
    // INI TAMBAHAN BARU: UPDATE FOOTER OTOMATIS
    const tahun = new Date().getFullYear();
    const namaToko = s.username || 'My Store';
    const copyrightEl = document.getElementById('copyright');
    if (copyrightEl) copyrightEl.innerText = `© ${tahun} ${namaToko}`;
